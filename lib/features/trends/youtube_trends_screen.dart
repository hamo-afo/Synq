// lib/features/trends/youtube_trends_screen.dart
...
class YouTubeTrendsScreen extends StatefulWidget {
  ...
  @override
  State<YouTubeTrendsScreen> createState() => _YouTubeTrendsScreenState();
}

class _YouTubeTrendsScreenState extends State<YouTubeTrendsScreen> {
  ...
  void _loadTrends() {
    setState(() {
      _future = _repo.fetchYoutubeTrends();
    });
  }
